...
#define configTICK_RATE_HZ              ( ( TickType_t ) 100000 ) //100,000
...
#define pdTICKS_TO_US( xTicks )    ( ( ( TickType_t ) ( xTicks ) * 1000000u ) / configTICK_RATE_HZ )
...
// Variables for getting runtime diagnostics
//extern volatile unsigned long ulHighFrequencyTimerTicks;
/* ulHighFrequencyTimerTicks is already being incremented at 1MHz.  Just set
its value back to 0. */
